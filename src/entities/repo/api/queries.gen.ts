...
export function useRepoListQuery(
  baseOptions: Apollo.QueryHookOptions<RepoListQuery, RepoListQueryVariables> &
    ({ variables: RepoListQueryVariables; skip?: boolean } | { skip: boolean })
) {
...
export function useRepoListLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<RepoListQuery, RepoListQueryVariables>(
    RepoListDocument,
    options
  );
}
export function useRepoListSuspenseQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<RepoListQuery, RepoListQueryVariables>(
    RepoListDocument,
    options
  );
}
export type RepoListQueryHookResult = ReturnType<typeof useRepoListQuery>;
export type RepoListLazyQueryHookResult = ReturnType<
  typeof useRepoListLazyQuery
>;
export type RepoListSuspenseQueryHookResult = ReturnType<
  typeof useRepoListSuspenseQuery
>;
export type RepoListQueryResult = Apollo.QueryResult<
  RepoListQuery,
  RepoListQueryVariables
>;
